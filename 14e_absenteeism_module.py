...
# -*- coding: utf-8 -*-
"""
Created on Wed Dec 11 00:52:37 2019

@author: b
Prepare the deployment  of the model through a module
model: the analytical tool applied to solve the business problem
module: a software component containing the code that will help us execute the 'model'
"""
